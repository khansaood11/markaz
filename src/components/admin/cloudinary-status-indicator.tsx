...
import { checkCloudinaryConnection } from '@/app/admin/actions';
...
export default function CloudinaryStatusIndicator() {
  ...
  const statusConfig = {
    checking: {
      ...
      text: 'Checking Cloudinary...',
      tooltip: 'Verifying Cloudinary configuration...',
    },
    connected: {
      color: 'bg-green-500',
      text: 'Cloudinary Ready',
      tooltip: 'Cloudinary is configured for uploads.',
    },
    disconnected: {
      color: 'bg-red-500',
      text: 'Cloudinary Error',
      tooltip: `Configuration error: ${error}`,
    },
  };
